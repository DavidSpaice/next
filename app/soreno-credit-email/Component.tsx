...
const SubmitCreditEmail: React.FC = () => {
  ...
  const handleConfirmSubmit = async () => {
    const response = await fetch(
      "https://airtek-warranty.onrender.com/credit/sendSorenoCreditEmail",
      {
        method: "POST",
        headers: {
  ...
  return (
    <div className="max-w-lg mx-auto p-8 border border-[#182887] rounded-lg bg-gray-100">
      <h1 className="text-center text-[#182887] text-2xl font-semibold mb-6">
        Soreno Credit Email
      </h1>
      ...
      {showConfirmation && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>
              <strong>Credit Amount:</strong> {credit}
            </p>
            <p>
